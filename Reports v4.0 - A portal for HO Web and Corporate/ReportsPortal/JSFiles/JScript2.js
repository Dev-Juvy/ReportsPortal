Sys.Application.add_init(function () {
    ...
    //  of the Save button.
    $addHandler($get('Next'), 'click', function () {
        $('#EntryForm1').block({ message: null });
    ...
    prm.add_endRequest(function (args, sender) {
        ...
        $('#EntryForm1').block({ message: $('#ConfirmSave') });

        $('#CloseConfirm').click(function (evt) {
